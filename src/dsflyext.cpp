...
// initialize control variables
    printf("Start: extract control-1\n");
    ...
    printf("Start: extract control-4\n");
    ...
    printf("Start: extract control-5\n");
    ...
    ctl.iPK             = extract<int>(ctrlist[26]);
    printf("Start: extract control-1\n");

    
    printf("Start: extract control-6\n");
